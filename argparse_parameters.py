...
def get_arg_parser():
    ...
    parser.add_argument('--cache_dir', default = "/projectnb/textconv/cliao25/data", 
                        type =str)
    parser.add_argument('--data_dir', default = "/scratch/cliao25", type =str)
    ...
    parser.add_argument('--text_prompt_depth', default = 0, type=int)
    parser.add_argument('--train_text_encoder', default = 0, type=int)
    parser.add_argument('--train_visual_encoder', default = 0, type=int)
